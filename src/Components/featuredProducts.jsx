...
export default function Example() {
  return (
    <div className="bg-white max-w-7xl mx-auto lg:w-[92%] md:w-11/12">
      <div className=" max-w-2xl lg:pb-16 lg:pt-0 md:pt-0 px-4 sm:py-24 sm:px-6 lg:max-w-full lg:px-8 lg:w-[1250px] md:w-11/12 mx-auto bg-white">
